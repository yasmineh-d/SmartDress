    ...
    <div class="bg-white rounded-[2.5rem] p-8 text-center space-y-6 border border-tan/10 shadow-sm">
        <div class="w-32 h-32 rounded-full bg-gradient-to-tr from-tan to-moss p-[4px] mx-auto">
            <div class="w-full h-full bg-white rounded-full flex items-center justify-center overflow-hidden">
                <img :src="'https://ui-avatars.com/api/?name=' + encodeURIComponent(userName) + '&background=889063&color=fff&size=200'" alt="Avatar large">
            </div>
        </div>
        <div class="space-y-1">
            <h2 class="text-2xl font-display font-medium italic text-bark" x-text="userName">Utilisateur</h2>
            <p class="text-[10px] font-bold text-tan uppercase tracking-widest" x-text="userEmail">user@example.com</p>
        </div>
