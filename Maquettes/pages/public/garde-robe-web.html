...
<body class="bg-offwhite font-body text-bark min-h-screen flex flex-col">
            ...
            <div class="max-w-6xl mx-auto space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="clothing-grid">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button onclick="toggleFavorite(event, this)"
                                    class="w-8 h-8 bg-white border border-tan/10 rounded-full flex items-center justify-center text-tan shadow-sm transition-colors"><svg
                                        class="w-4 h-4 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div data-category="accessoires"
                        class="clothing-card group relative bg-white rounded-[2.5rem] border border-tan/10 p-3 shadow-xl shadow-bark/5 hover:-translate-y-2 transition-all duration-300">
                        <div
                            class="aspect-square bg-cream/40 rounded-[1.5rem] flex items-center justify-center text-6xl relative overflow-hidden transition-colors group-hover:bg-cream/50">
                            <span class="zoom-img transition-transform duration-500">👜</span>
                            <div
                                class="absolute top-4 right-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button onclick="toggleFavorite(event, this)"
                                    class="w-8 h-8 bg-white border border-tan/10 rounded-full flex items-center justify-center text-tan hover:text-red-500 shadow-sm transition-colors"><svg
                                        class="w-4 h-4 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                    </svg></button>
                            </div>
    ...
    <script>
        ...
        function setSidebarCategory(cat) {
            ...
            buttons.forEach(btn => {
                if (btn.id === `btn-cat-${cat}`) {
                    ...
                    if (spanCount.classList.contains('opacity-60')) {
                        spanCount.classList.replace('opacity-60', 'text-tan');
                    }
                }
            });
        ...
        // Preline custom event for select change (delegated)
        ...
        function addItemToGrid() {
            ...
            const icon = category === 'hauts' ? '👕' : category === 'bas' ? '👖' : category === 'chaussures' ? '👟' : '🛍️';
            ...
            newCard.innerHTML = `
                <div class="aspect-[4/5] bg-cream/40 rounded-[2rem] overflow-hidden relative mb-4">
                    ...
                    <button onclick="toggleFavorite(event, this)" class="absolute top-4 right-4 w-10 h-10 bg-white/80 backdrop-blur-md rounded-2xl flex items-center justify-center text-tan hover:text-red-500 transition-all shadow-sm z-10">
                ...
                <div class="px-2 space-y-1">
                    <p class="text-[9px] font-bold text-tan uppercase tracking-[0.15em]">Nouvel article</p>
