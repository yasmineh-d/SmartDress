...
<body class="bg-offwhite font-body text-bark min-h-screen flex flex-col">
    ...
    <main class="flex-1 max-w-3xl w-full mx-auto p-8 lg:p-20">
        <div class="space-y-12 text-center">
            <div class="space-y-6">
                ...
                <p class="text-lg text-tan font-light leading-relaxed max-w-xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-xl mx-auto">
                <div class="bg-white p-8 rounded-3xl border border-tan/10 shadow-xl shadow-bark/5 flex flex-col items-center text-center space-y-4 group">
                    ...
                    <div>
                        ...
                        <p class="text-bark font-medium mt-1">contact@smartdress.fr</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-3xl border border-tan/10 shadow-xl shadow-bark/5 flex flex-col items-center text-center space-y-4 group">
                    ...
                    <div>
                        ...
                        <p class="text-bark font-medium mt-1">123 Avenue de la Mode, 75001 Paris</p>
                    </div>
                </div>
            </div>
        </div>
