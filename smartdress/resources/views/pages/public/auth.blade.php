    ...
    <div class="w-full max-w-[320px] my-8 relative z-10">
        ...
        <div class="bg-white p-6 rounded-[2.5rem] shadow-2xl shadow-bark/40 space-y-5 relative overflow-hidden">
            ...
            <div class="grid grid-cols-2 gap-3">
                <button
                    class="flex items-center justify-center py-3.5 bg-white border border-tan/20 rounded-xl hover:bg-cream/20 transition-all group">
                    <span class="text-[9px] font-bold text-tan uppercase tracking-widest group-hover:text-bark">Google</span>
                </button>
                <button
                    class="flex items-center justify-center py-3.5 bg-white border border-tan/20 rounded-xl hover:bg-cream/20 transition-all group">
                    <span class="text-[9px] font-bold text-tan uppercase tracking-widest group-hover:text-bark">Apple</span>
                </button>
            </div>
        </div>
    </div>
